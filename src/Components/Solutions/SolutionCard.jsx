...
export default function SolutionCard({ SolutionImage, SolutionImage2 }) {
    ...
    { title: t("Last-Mile Solutions"), description: t("Deliver exceptional service right to your customer's doorstep with our last-mile solutions. Mapit's advanced routing and communication tools ensure that every delivery is completed quickly and accura..."), imageUrl: SolutionImage2 }
        , { title: t("Mapit Ship"), description: t("Ship your orders with the best shipping companies in KSA"), imageUrl: SolutionImage2 }]
    ...
    return (
        <Container>
            ...
            >
                ...
                <Grid item md={8} xs={12} sx={{  pt: { xs: "2rem" } }}>
