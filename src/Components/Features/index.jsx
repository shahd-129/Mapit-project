...
import { Box,Typography, useMediaQuery, Button, Container } from "@mui/material";
import { FeatuerImage, FeatuerImage2, FeatuerImage3 } from "../../assets";
import { Trans, useTranslation } from "react-i18next";
import FeaturesCardsList from "./FeaturesCardsList";
import FearturesSlider from "./FearturesSlider";
...
const FeaturesSection = () => {
    ...
    return (
        <Container>
            ...
            {isSmallScreen ?
                <FearturesSlider features={features} />
                :
                <FeaturesCardsList features={features} />
            }
